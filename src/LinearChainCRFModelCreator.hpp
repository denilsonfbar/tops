/*
 *       LinearChainCRFModelCreator.hpp
 *
...
#ifndef LINEAR_CHAIN_CRF_MODEL_CREATOR_HPP
#define LINEAR_CHAIN_CRF_MODEL_CREATOR_HPP
...
namespace tops {
  ...
  class DLLEXPORT LinearChainCRFModelCreator : public ProbabilisticModelCreator
  {
  public:
    LinearChainCRFModelCreator() {}
    virtual ~LinearChainCRFModelCreator(){};
    ...
    virtual std::string help() const
    {
      ...
      out << "\tmodel_name = \"LinearChainCRFModel\"" << std::endl;
  ...
  typedef boost::shared_ptr < LinearChainCRFModelCreator> LinearChainCRFModelCreatorPtr;
}
