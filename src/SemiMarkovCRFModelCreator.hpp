...
#ifndef SEMI_MARKOV_CRF_MODEL_CREATOR_HPP
#define SEMI_MARKOV_CRF_MODEL_CREATOR_HPP
...
namespace tops {
  ...
  class DLLEXPORT SemiMarkovCRFModelCreator : public ProbabilisticModelCreator
  {
  public:
    SemiMarkovCRFModelCreator() {}
    virtual ~SemiMarkovCRFModelCreator(){};
    ...
    virtual std::string help() const
    {
      ...
      out << "\tmodel_name = \"SemiMarkovCRFModel\"" << std::endl;
  ...
  typedef boost::shared_ptr < SemiMarkovCRFModelCreator> SemiMarkovCRFModelCreatorPtr;
}
